...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Danh sách đơn chờ duyệt</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('admin/');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Danh sách đơn chờ duyệt</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive p-0">
                                <table id="datatable1" class="table table-striped table-bordered text-center">
                                    ...
                                    <tbody>
                                       <?php $i= 0; foreach ($CMSNT->get_list("SELECT * FROM `dichvu_history` WHERE `status` = 'choduyet' ORDER BY id DESC ") as $row) {?>
                                        <tr>
                                            <td><?=$i++;?></td>
